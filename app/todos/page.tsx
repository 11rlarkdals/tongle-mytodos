      ...
      <div className="w-full flex flex-col items-center bg-gradient-to-r from-blue-500 to-purple-500 text-white">
        ...
        <div className="w-full px-12">
          ...
          <div className="max-w-[56rem] flex flex-col items-center mx-auto">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 w-full text-white gap-4">
              {tasks.map((task) => (
                <div
                  key={task.id}
                  onClick={() => {
                ...
                >
                  <div
                    ...
                    className={`relative hover:ring-4 rounded-lg w-14 sm:w-full pl-16 py-4 cursor-pointer text-white text-[1.1rem] h-14 `}
                  >
